...
function assessFinanto(extract, contract) {
  ...
  if (contract.payoff >= 8000 && extract.financial.availableMargin >= 0) {
    return offer(
      "Finanto",
      "eligible",
      "Portabilidade pura: saldo devedor igual ou superior a R$ 8.000.",
      "Portabilidade pura",
      "jul/26",
      96,
    );
...
function assessC6(extract, contract) {
  ...
  return offer(
    ...
    extract.financial.availableMargin < 0
      ...
      : "Ticket mínimo atendido; permite portabilidade pura ou com refin.",
    "Portabilidade pura ou + refin",
    "jul/26",
    89,
  );
}
...
function assessAcredto(extract, contract) {
  ...
  if (extract.financial.availableMargin < 0) {
    return offer(
      ...
      contract.payoff >= 6000 ? "Portabilidade pura ou + refin" : "Portabilidade + refin",
      "24/07/26",
      48,
    );
  }
  return offer(
    ...
    contract.payoff >= 6000
      ? "Saldo atende à portabilidade pura e também à portabilidade com refin."
...
function assessTotalCash(extract, contract) {
  ...
  return offer(
    ...
    contract.payoff >= 4000
      ? "Ticket atendido; permite portabilidade pura ou com refin."
      : "Ticket atendido somente com o troco mínimo do refinanciamento.",
    contract.payoff >= 4000 ? "Portabilidade pura ou + refin" : "Portabilidade + refin",
    "jul/26",
